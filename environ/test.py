...
class EnvTests(BaseTests):
    ...
    def test_db_url_value(self):
        ...
        sqlite_config = self.env.db('DATABASE_MSSQL_URL')
        self.assertEqual(sqlite_config['ENGINE'], 'sql_server.pyodbc')
        self.assertEqual(sqlite_config['NAME'], 'sampledatabase')
        self.assertEqual(sqlite_config['HOST'], 'samplehost.com')
        self.assertEqual(sqlite_config['USER'], 'sampleuser')
        self.assertEqual(sqlite_config['PASSWORD'], 'samplepassword')
        self.assertEqual(sqlite_config['PORT'], 1433)
        self.assertEqual(sqlite_config['OPTIONS'], {
